...
// You can read more about it in the documentation: https://doc.rust-lang.org/std/convert/trait.From.html
...
// We implement the Default trait to use it as a fallback when the provided string is not convertible into a `Person` object.
...
impl From<&str> for Person {
    fn from(s: &str) -> Self {
        ...
        if let Ok(num) = list.last().unwrap().to_owned().parse::<u8>() {
            Person{
